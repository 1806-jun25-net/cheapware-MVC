...
namespace CheapWare.WebApp.Controllers
{
    public class CustomersController : AServiceController
    {
        ...
        public CustomersController(HttpClient httpClient) : base(httpClient)
        { }
        ...
        public async Task<ActionResult> Index()
        {
            ...
            var request = CreateRequestToService(HttpMethod.Get, "api/customers");
            ...
            try
            {
                ...
                List<Customers> customers = JsonConvert.DeserializeObject<List<Customers>>(jsonString);
        ...
        public async Task<ActionResult> Create(Customers customer)
        {
            try
            {
