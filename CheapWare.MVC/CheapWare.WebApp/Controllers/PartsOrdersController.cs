...
{
    public class PartsOrdersControllers : AServiceController
    {

        public PartsOrdersControllers(HttpClient httpClient) : base(httpClient)
        { }
        ...
        public async Task<ActionResult> Index()
        {
            ...
            var request = CreateRequestToService(HttpMethod.Get, "api/partsorders");
            ...
            try
            {
                ...
                List<PartsOrders> po = JsonConvert.DeserializeObject<List<PartsOrders>>(jsonString);
        ...
        public async Task<ActionResult> Create(PartsOrders po)
        {
            try
            {
